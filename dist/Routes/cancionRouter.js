...
const cancionController = __importStar(require("../controller/cancionController"));
const cancionRouter = (0, express_1.Router)();
cancionRouter.get("/", authMiddleware_1.validateAuthorizationCanciones, cancionController.findAll);
